...
public class ArbolAVLIteradorPreOrdenInverso<T extends Comparable<? super T>> implements Iterador<T> {
    private NodoAVL<T> raizArbol;
    private final Iterador<T> iterador;

    public ArbolAVLIteradorPreOrdenInverso(ArbolAVLExt<T> arbolAvl,
                                           NodoAVL<T> raizArbol) {
