...
public class ArbolAVLIteradorPosOrdenInverso<T extends Comparable<? super T>> implements Iterador<T> {
    private NodoAVL<T> raizArbol;
    private final Iterador<T> iterador;

    public ArbolAVLIteradorPosOrdenInverso(ArbolAVLExt<T> arbolAvl,
                                           NodoAVL<T> raizArbol) {
